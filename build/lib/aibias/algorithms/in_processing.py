...
class PR_remover():
    ...
    def __init__(self,dataset,epochs=1,eta=5,ntrain=1000,use_pr_regularizer=True):
        """
        Arguments:
    ...
    def fit(self):
        ...
        if self.use_pr_regularizer:
            reg = self.PR_regularizer
        else:
...
def PrejudiceRemover(dataset,epochs,eta=5,ntrain=1000,use_pr_regularizer=True):
    ...
    pr_remover = PR_remover(dataset,epochs,eta,ntrain,use_pr_regularizer)
